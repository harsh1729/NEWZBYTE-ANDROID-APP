...
public class ArcMenu extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        li.inflate(R.layout.arcmenu_arc_menu, this);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                	...
                	//if(!mArcLayout.isExpanded())
                		//controlLayout.setBackgroundResource(R.drawable.arcmenu_share_cancel_btn);
                	//else
                		//controlLayout.setBackgroundResource(R.drawable.arcmenu_share_share_btn);
                    //mHintView.startAnimation(createHintSwitchAnimation(mArcLayout.isExpanded()));
                   // mArcLayout.switchState(true);
                	switchShareArcmenu(true);
                }
    ...
    public void switchShareArcmenu(boolean doAnimation)
    {
    	if(!mArcLayout.isExpanded())
    		...
    		controlLayout.setBackgroundResource(R.drawable.arcmenu_share_share_btn);
        //mHintView.startAnimation(createHintSwitchAnimation(mArcLayout.isExpanded()));
        mArcLayout.switchState(doAnimation);
    }
    ...
    private OnClickListener getItemClickListener(final OnClickListener listener) {
        return new OnClickListener() {
            ...
            public void onClick(final View viewClicked) {
                ...
                ViewGroup controlLayout = (ViewGroup) findViewById(R.id.control_layout);
                //TODO
            	if(!mArcLayout.isExpanded())
            		controlLayout.setBackgroundResource(R.drawable.arcmenu_share_cancel_btn);
            	else
