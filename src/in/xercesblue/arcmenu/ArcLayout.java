...
package in.xercesblue.arcmenu;

import in.newzbyte.app.Activity_Home;
import in.newzbyte.app.R;
...
public class ArcLayout extends ViewGroup {
    ...
    private int mLayoutPadding = 10;//default = 10
    ...
    private static final int MIN_RADIUS = 100;//default = 100
    ...
    private static int computeRadius(final float arcDegrees, final int childCount, final int childSize,final int childPadding, final int minRadius) {
        ...
        final float perHalfDegrees = perDegrees / 10;
    ...
    @SuppressLint("NewApi")
	private static Point getScreenSize(Activity currentActivity){
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        final int menuDimen =(int) getResources().getDimension(R.dimen.menuChildSize);
        float degrees = mFromDegrees;
        
        for (int i = 0; i < childCount; i++) {
            //Rect frame = computeChildFrame(centerX, centerY, radius, degrees, mChildSize);
        	Rect frame =computeChildFrame(centerX*2-menuDimen/2, centerY*2-menuDimen/2, radius, degrees, menuDimen);
            degrees += perDegrees;
            //getChildAt(i).layout(getWidth()-mChildSize,getHeight()-mChildSize,getWidth(),getHeight());//frame.left, frame.top, frame.right, frame.bottom);
            getChildAt(i).layout(frame.left, frame.top, frame.right, frame.bottom);
            //getChildAt(i).layout(centerX*2-50, centerY*2-50, centerX*2, centerY*2);
        }
    }
    ...
    private void bindChildAnimation(final View child, final int index, final long duration) {
        ...
        //Rect frame = new Rect(centerX*2-50, centerY*2-50, centerX*2, centerY*2);
        Rect frame = computeChildFrame(centerX*2-menuDimen/2, centerY*2-menuDimen/2, radius, mFromDegrees + index * perDegrees,menuDimen);
    ...
    private void onAllAnimationsEnd() {
        ...
        if(activity.getClass() == Activity_Home.class){
        	...
        	Activity_Home mainAct = (Activity_Home)activity;
        	if(mainAct.shareOptionNo >= 0){
